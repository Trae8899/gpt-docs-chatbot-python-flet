...
from VectorConvert import VectorConvert
from setting_api import set_api
from Json_Upload import JsonUpload
...
class Chatlayout(ft.Row):
    def __init__(self, app ,page: ft.Page, *args, **kwargs):
        ...
        self.convert=VectorConvert(self.page)
        self.jsonup=JsonUpload(self.page)
    ...
    def set_upload_view(self):
        self.active_view = self.jsonup.build_page()
        self.active_view.update
        self.page.update()
